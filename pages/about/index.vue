  ...
  <div class="bg-gray-800">
    <div class="page-content" v-if="data">
      <div class="title text-center w-full">
        ...
        <h2 class="text-4xl text-orange-200 p-10">{{ data.subtitle }}</h2>
        <div
        ...
        >
          ...
          <div class="paragraph w-full my-auto mx-auto shadow-xl rounded border-solid border-neutral-100 border-2">
      ...
      <div
        class="card-section p-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-40 text-white text-xl"
      >
        <div class="card1 rounded overflow-hidden shadow-lg border-solid border-neutral-100 border-2">
        ...
        <div class="card2 rounded overflow-hidden shadow-lg border-solid border-neutral-100 border-2">
          <div class="image-warpper w-full max-h-80 overflow-hidden">
        ...
        <div class="card3 rounded overflow-hidden shadow-lg border-solid border-neutral-100 border-2">
          <div class="image-warpper w-full max-h-80 overflow-hidden">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-40 py-40 mx-20">
